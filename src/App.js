  ...
  useEffect(function () {
    async function fetchMovies() {
      try {
        ...
        //If there is an error, code stops here and continues on finally...;
        ...
        //This line of code is always executed at the end;
        setIsLoading(false);
      }
    }
    fetchMovies();
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {error && <ErrorFetching message={error} />}
        </Box>
